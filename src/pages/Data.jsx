    ...
    return (
        <div className=' w-full flex flex-col min-h-screen max-h-screen bg-gradient-to-l from-[#2575fc] to-[#6a11cb] p-12'>
            ...
            <div className='flex flex-col md:hidden w-full'>
                ...
                <div className='w-full fixed bottom-10 flex md:hidden items-center mt-8 justify-between px-10 left-0 right-0'>
                    <button onClick={() => preImage()} className='  items-center  justify-center text-lg  w-28 h-16 sm:h-16 bg-white text-[#6a11cb] font-bold rounded-full shadow-md hover:scale-105 transition-transform duration-300'>← Previous</button>
                    <button onClick={() => nextImage()} className=' items-center justify-center text-lg w-28 h-16 sm:h-16 bg-white text-[#6a11cb] font-bold rounded-full shadow-md hover:scale-105 transition-transform duration-300'>Next →</button>
                </div>
            </div>
        </div>
    )
